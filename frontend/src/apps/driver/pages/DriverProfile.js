...
import { User, Mail, Phone, Camera, Lock, Shield, CheckCircle, Clock, AlertCircle, Truck } from 'lucide-react';

const DriverProfile = () => {
  const { user, API, updateUser } = useContext(DriverContext);
  ...
  if (showVerification) {
    return (
      <div className="profile-page">
        ...
        <style jsx>{`
          .profile-page { min-height: 100vh; background: linear-gradient(135deg, #10b981 0%, #059669 100%); display: flex; align-items: center; justify-content: center; padding: 24px; }
          ...
          .verification-icon { color: #10b981; margin-bottom: 16px; }
          ...
          .btn-primary { width: 100%; padding: 14px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: white; border: none; border-radius: 12px; font-size: 16px; font-weight: 700; cursor: pointer; transition: all 0.3s; margin-bottom: 16px; }
          ...
          .btn-link { background: none; border: none; color: #10b981; font-weight: 600; cursor: pointer; padding: 8px; font-size: 14px; }
    ...
    <div className="profile-page">
      <div className="profile-container">
        <div className="profile-header">
          ...
          <p>Manage your delivery partner account and verification status</p>
        </div>
      ...
      <style jsx>{`
        ...
        .profile-pic { width: 120px; height: 120px; border-radius: 50%; object-fit: cover; border: 4px solid #10b981; }
        ...
        .upload-btn { position: absolute; bottom: 0; right: 0; background: #10b981; color: white; padding: 8px 12px; border-radius: 20px; font-size: 12px; font-weight: 600; cursor: pointer; display: flex; align-items: center; gap: 4px; border: 2px solid white; }
        ...
        .btn-submit { width: 100%; padding: 14px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: white; border: none; border-radius: 12px; font-size: 16px; font-weight: 700; cursor: pointer; transition: all 0.3s; }
        .btn-submit:hover:not(:disabled) { transform: translateY(-2px); box-shadow: 0 4px 12px rgba(16, 185, 129, 0.3); }
        ...
        .verify-btn { padding: 6px 12px; background: #10b981; color: white; border: none; border-radius: 8px; font-size: 12px; font-weight: 600; cursor: pointer; }
