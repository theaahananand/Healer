    ...
    return (
      <div className="auth-page">
        ...
        <style jsx>{`
          ...
          .btn-submit { width: 100%; padding: 14px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: white; border: none; border-radius: 12px; font-size: 16px; font-weight: 700; cursor: pointer; }
    ...
    <div className="auth-page">
      <div className="auth-card">
        ...
        <form onSubmit={handleSubmit}>
          {!isLogin && (
            <div className="form-group">
              <label><User size={18} /> Full Name <span className="required">*</span></label>
              <input type="text" value={formData.name} onChange={(e) => setFormData({ ...formData, name: e.target.value })} required data-testid="name-input" placeholder="Enter your full name" />
            </div>
          )}

          <div className="form-group">
            <label><Mail size={18} /> Email <span className="required">*</span></label>
            <input type="email" value={formData.email} onChange={(e) => setFormData({ ...formData, email: e.target.value })} required data-testid="email-input" placeholder="driver@example.com" />
          </div>
      ...
      <style jsx>{`
        ...
        .forgot-link button { background: none; border: none; color: #10b981; font-size: 14px; font-weight: 600; cursor: pointer; }
        .btn-submit { width: 100%; padding: 14px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: white; border: none; border-radius: 12px; font-size: 16px; font-weight: 700; cursor: pointer; }
        .btn-submit:disabled { opacity: 0.6; }
        .toggle { margin-top: 24px; color: #64748b; }
        .toggle button { background: none; border: none; color: #10b981; font-weight: 600; cursor: pointer; }
