...
import { Mail, Lock, User, Phone, Store, Pill } from 'lucide-react';
  ...
  return (
    <div className="auth-page">
      ...
      <style jsx>{`
        ...
        button[type="submit"] { width: 100%; padding: 14px; background: linear-gradient(135deg, #8b5cf6 0%, #7c3aed 100%); color: white; border: none; border-radius: 12px; font-size: 16px; font-weight: 700; cursor: pointer; }
